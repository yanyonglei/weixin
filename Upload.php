...
class Upload
{
	//路径
	public $path = './upload';
	protected $allowMime = array('image/jpeg' , 'image/png' , 'image/gif' , 'image/wbmp','audio/mp3','video/mp4','application/octet-stream');
	//准许的文件后缀名
	protected $allowSub = array('jpg' , 'png' , 'gif' , 'wbmp' , 'jpeg','amr','mp4','mp3');
	//准许的大小
